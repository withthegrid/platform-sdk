...
class MeasurementFilterRoute {
  static routerPath = 'measurement-filter';
  ...
  add = (parameters: add.Request):
    ...
    >(
      ...
      MeasurementFilterRoute.routerPath,
      MeasurementFilterRoute.auth,
      this.comms,
    )(parameters);
...
export default MeasurementFilterRoute;
