...
class SupplierWebhookRoute {
  static routerPath = 'supplier-webhook';
  ...
  add = (parameters: add.Request):
    ...
    >(
      ...
      SupplierWebhookRoute.routerPath,
      SupplierWebhookRoute.auth,
      this.comms,
    )(parameters);
...
export default SupplierWebhookRoute;
